...
export class SearchFilter {
    ...
    GetBLMDetails() {
      ...
      OpportunityData(PK_Cust_Id) {
        return this.http.post(`${environment.apiUrl}/Api_SearchFilter/OpportunityData?PK_Cust_Id=` + PK_Cust_Id, {});
      }
      ...
      private saveAsExcelFile(buffer: any, fileName: string): void {
        ...
        FileSaver.saveAs(data, fileName + 'Report_' + EXCEL_EXTENSION);
      }
